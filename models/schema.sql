...
("chuck norris", "momadison@me.com", "wheni1sneeze2u3die"),
("jeffrey skilling", "mattomadison@gmail.com", "ihavelotsofo1l");
INSERT INTO OPERATOR (operatorName, operatorNumber, operatorAddress, operatorPhone, operatorBirthday, h15rules,  authID) VALUES
...
INSERT INTO MEMBER (memberName, memberTitle, operateID) VALUES
("chuck norris", "president", 1),
("jeffrey skilling", "coo", 2);
INSERT INTO OPFIELD (fieldName, fieldNumber, fieldRules, operatorID) VALUES
("tunstill east (delaware)","91818500", "2019-06-01", 1),
("turner gregory  (clear fork)","91903333", "2019-03-01", 2);
INSERT INTO LEASE (districtNumber, countyName, leaseName, leaseNumber, fieldID) VALUES
...
("well_3", "90123156", 3, "1975-12-12", "2012-7-29", NULL, 2),
("well_4", "56034596", 4, "1951-8-30", "1972-8-29", NULL, 1),
...
("Production", 2,"annually", "help desk", "5124636726"),
